...
-- This Is Akiri lib This is not custom library for synapsehook it is base akiri lib with name changed 
-- // Library Init \\ --
local Start = tick()
local LoadTime = tick()
...
do
    ...
    Utility.SaveConfig = function(Config)
        ...
        writefile(
            "SynapseHook/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local CFG = HttpService:JSONDecode(readfile("SynapseHook/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("SynapseHook/Assets/UI/Logo2.png", "https://i.imgur.com/LbR3IoH.png")
        --
        ...
        --
        Utility.AddFolder("SynapseHook")
        Utility.AddFolder("SynapseHook/Caches")
        Utility.AddFolder("SynapseHook/Assets")
        Utility.AddFolder("SynapseHook/Assets/UI")
        Utility.AddFolder("SynapseHook/Configs")
        Utility.AddFolder("SynapseHook/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("SynapseHook/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("SynapseHook/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("SynapseHook/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("SynapseHook/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("SynapseHook/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Dummy = Utility.AddImage("SynapseHook/Assets/UI/Dummy.png", "https://i.imgur.com/6M6buVv.png")
        Library.Theme.Astolfo = Utility.AddImage("SynapseHook/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("SynapseHook/Assets/UI/Aiko.png", "https://i.imgur.com/1gRIdko.png")
        Library.Theme.Rem = Utility.AddImage("SynapseHook/Assets/UI/Rem.png", "https://i.imgur.com/ykbRkhJ.png")
        Library.Theme.Violet = Utility.AddImage("SynapseHook/Assets/UI/Violet.png", "https://i.imgur.com/7B56w4a.png")
        Library.Theme.Asuka = Utility.AddImage("SynapseHook/Assets/UI/Asuka.png", "https://i.imgur.com/3hwztNM.png")
        --
        if not isfolder("SynapseHook/Configs/" .. game.PlaceId) then
            makefolder("SynapseHook/Configs/" .. game.PlaceId)
        end
        --
        ...
        function Window:Tab(Title)
            ...
            function Tab:Section(Title, Side)
                ...
                function Section:TextBox(Options)
                    ...
                    InputHandler.Name = ("SynapseHook-INPUT-%s"):format(HttpService:GenerateGUID(false))
                    --
